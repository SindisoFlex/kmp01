...
const RegisterForm: React.FC = () => {
    ...
    try {
      ...
      if (result && result.needsConfirmation) {
        toast({
          ...
          description: "We've sent a confirmation link to your inbox. Please click it to activate your account.",
        });
      } else {
        toast({
          title: `🎉 Welcome to Kasilam Media production, ${values.name.split(' ')[0]}!`,
  ...
  return (
    <div className="space-y-6">
      {registrationMethod !== 'form' && showSocialSection && (
