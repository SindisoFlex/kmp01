...
const StaffLoginForm: React.FC<StaffLoginFormProps> = ({ onSuccess }) => {
  ...
  return (
    <div className="space-y-4 py-2 pb-4">
      <div className="space-y-2 mb-4">
        <h2 className="text-xl font-semibold tracking-tight text-center">Staff Portal</h2>
      ...
      <p className="text-center text-sm text-muted-foreground mt-4">
        ...
        <br />
        <code className="text-xs bg-muted px-1 py-0.5 rounded">staff@example.com</code> / <code className="text-xs bg-muted px-1 py-0.5 rounded">staffpass</code>
      </p>
    </div>
  );
};
