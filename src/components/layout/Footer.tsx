    ...
    <footer className="bg-muted py-12">
      <div className="page-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-muted-foreground max-w-md">
              Kasilam Media production is a creative agency focused on design, development, and digital experiences
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="mailto:hello@kasilammedia.com" className="text-muted-foreground hover:text-foreground">hello@kasilammedia.com</a></li>
        ...
        <div className="mt-12 pt-8 border-t border-muted-foreground/20 flex flex-col md:flex-row justify-between items-center text-muted-foreground text-sm">
          <p>© {currentYear} Kasilam Media production. All rights reserved.</p>
